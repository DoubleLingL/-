...
def readIn():
    ...
    with open('/home/hll/PycharmProjects/GridMap/gridMap/data/0905.csv', 'r') as f:
        l = f.readlines()
...
def writeJs(data):
    ...
    with open('/home/hll/PycharmProjects/GridMap/gridMap/app/static/borders_0905.js', 'w') as f:
