...
model.fit(trainX, trainY, epochs=2000, batch_size=16, verbose=2)
# make predictions
...
plt.legend()
plt.suptitle('2LSTM_2000_16_0.1_0.02')
plt.show()
...
plt.title('2LSTM_2000_16_0.1_0.02    9.24')
plt.legend()
plt.show()
...
plt.title('2LSTM_2000_16_0.1_0.02    9.25')
plt.legend()
plt.show()